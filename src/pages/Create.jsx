  ...
  const classes = [
    {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-beast-painter.svg",
        disabled: true,
        templateIndex:2
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-engineer.svg",
        disabled: true,
        templateIndex:3
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-drop-hunter.svg",
        disabled: false,
        templateIndex:0
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-the-degen.svg",
        disabled: true,
        templateIndex:6
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-neural-hacker.svg",
        disabled: false,
        templateIndex:1
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-lisk-witch.svg",
        disabled: true,
        templateIndex:4
      },
      {
        ...
        icon: import.meta.env.VITE_PUBLIC_PATH + "/assets/icons/class-bruiser.svg",
        disabled: true,
        templateIndex:5
      },
  ]
